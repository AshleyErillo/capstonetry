    ...
    def save_model(self, request, obj, form, change):
        if change:
            ...
            if (
                ...
                send_mail(
                    subject='You’re In – Your SmartSupport Account Is Approved',
                    message=(
                            f"Dear Employee,\n\n"
                            f"We are pleased to inform you that your SmartSupport account has been successfully created.\n"
